...
Passive public-footprint mapper. Give it a domain, URL, IP, or brand. Prex builds an exposure graph from DNS, registration data, certificate names, and one homepage fetch — then explains every result. It does not scan ports, guess passwords, or invent an owner.
